...
var newYear = () => {
    ...
    // 新年时间戳 and 星期对象
    let newYear = new Date('2023-06-07 09:00:00').getTime() / 1000,
    ...
    function time() {
        ...
        // 小于0则表示已经过年
        if (second < 0) {
            document.querySelector('#newYear .title').innerHTML = '考的全会蒙的全对';
            document.querySelector('#newYear .newYear-time').innerHTML = '<span class="happyNewYear">高考吉祥<p></p>';
        } else {
            // 大于0则还未过年
            document.querySelector('#newYear .title').innerHTML = '距离2023年高考：'
